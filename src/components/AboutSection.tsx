import { Landmark, Leaf, Palmtree } from "lucide-react";
import aboutImg from "@/assets/property-1.jpg";

const sisterConcerns = [
  { name: "Coniva Holdings Ltd", icon: Landmark, desc: "Community-based real estate development and premium land projects." },
  { name: "Coniva Agro Ltd", icon: Leaf, desc: "Sustainable farming, agro-estates and eco-friendly food production." },
  { name: "Coniva Resort Ltd", icon: Palmtree, desc: "Premium hospitality, wellness resorts and leisure destinations." },
];
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-base md:text-lg font-body leading-relaxed mb-5">
              Coniva Ltd is a values-driven real estate company headquartered in Banani, Dhaka. We deliver secure land investments, premium residential addresses and sustainable communities — built on transparency, legal safety and long-term value.
            </p>
            <p className="text-muted-foreground font-body leading-relaxed mb-8">
              Conjoining expertise across design, construction and hospitality, we craft developments that nurture lifestyle, belonging and lasting investment value. From first-time buyers to seasoned investors — develop with purpose, deliver with integrity.
            </p>
      ...
      <div id="sisters" className="bg-secondary section-padding">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center mb-14">
            ...
            <p className="text-muted-foreground font-body mt-4">A family of companies working across real estate, agriculture and hospitality.</p>
          </div>
